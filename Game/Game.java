...
public class Game {
	...
	private boolean wall_enabled=true,power_up=false,program_start=true, small_bonus=false;
	...
	//AU BOUT DE 50 POISSONS MANGES LE JOUEUR EST DIMINUE
	public void player_collide_item(String item_tag){
		if(item_tag.equals("fish")){
			eaten_fish++;
			if(eaten_fish==40){
				core.resize_poulp_by_half();
				small_bonus=true;
			}
	...
	public boolean is_mall_bonus_activaded(){
		return small_bonus;
	}
